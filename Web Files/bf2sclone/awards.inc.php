...
include_once('./queries/getBadgeByID.php');
include_once('./queries/getMedalByID.php');
include_once('./queries/getRibbonByID.php');
include_once('./queries/getSFRibbonsByID.php');
include_once('./queries/getSFBadgeByID.php');
...
{
	include('./queries/getAwardByPID_and_AWD.php'); // imports the correct sql statement
...
{
	include('./queries/getAwardByPID_and_AWD_NOLEVEL.php'); // imports the correct sql statement
	$result = mysql_query($query) or die('Query failed: ' . mysql_error());
