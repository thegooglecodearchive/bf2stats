...
<html xmlns="http://www.w3.org/1999/xhtml" class="inner"><head><title>My Leader Board, '.$SITE_TITLE.'</title>
...
<div id="page-1">
	...
	<div id="mlb-instructions">
		<p>Setup
your own leaderboard to track the stats of other Battlefield 2 players.
...
click "Save Leader Board" to keep the board in a cookie.</p>
		<p class="poof">This
service will work for BF2 players only. They must play on leased,
rented, or public Ranked Servers for the EA game Battlefield 2 in order
for this gaming website to be able to track their stats.</p>
...
# $LEADERBOARD = eg: '69595617,S. Wallberg,29000125'
foreach ($LEADER as $key => $value)
{
	$template .= '		
			<tr>
				<td><img src="'.$ROOT.'game-images/ranks/icon/rank_'.$value['rank'].'.gif" alt="" style="border: 0pt none ;"> 
...
$template .= '</tbody></table>
	...
	google_ad_client = "pub-6928434532700911";
	google_ad_width = 728;
	google_ad_height = 90;
	google_ad_format = "728x90_as";
	google_ad_type = "text_image";
	google_ad_channel ="";
	google_color_border = "252421";
	google_color_bg = "474642";
	google_color_link = "FFFFFF";
	google_color_url = "FFFFFF";
	google_color_text = "F0F0F0";
	//--></script>
	<script type="text/javascript" src="'.$ROOT.'show_ads.js">
	</script>
	</div>
