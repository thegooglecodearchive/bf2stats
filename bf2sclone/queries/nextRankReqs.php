...
function checkReqs($rank, $PID)
{
	...
	if($rank == 7 || $rank == 9)
	{
		...
		foreach($award_list as $award => $level)
		{
			...
			if(in_array($award, $player_awards))
			{
...
// *******************************************************************
// Main function... gets the next 3 ranks based on requirements
// IE: 1SG vs MSG, and MGYSG vs SGM
function getNext3($PID, $first, $second, $third)
{
